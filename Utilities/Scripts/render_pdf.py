...
<div style="width:100%; font-size:7pt; font-family:'Segoe UI',Arial,sans-serif; color:#1a3c6e; border-bottom:0.5pt solid #1a3c6e; padding:2mm 0; margin:0 8mm;">
  <span style="float:left; font-weight:600;">Utilities Process Flows</span>
  <span style="float:right;">EPRI UCBM / IEC 61970-61968-61850 / OpenADR / Green Button</span>
</div>
'''
...
<div style="width:100%; font-size:6.5pt; font-family:'Segoe UI',Arial,sans-serif; color:#888; border-top:0.5pt solid #ccc; padding:1.5mm 0; margin:0 8mm;">
  <span style="float:left;">Generated 2026-07-07</span>
...
<head>
<meta charset="UTF-8">
<title>Utilities Process Flows - EPRI UCBM</title>
...
with sync_playwright() as p:
    ...
    out_pdf = str(ROOT / "Document" / "utilities-process-flows.pdf")
    page.pdf(
        path=out_pdf,
        format="A4",
        landscape=True,
