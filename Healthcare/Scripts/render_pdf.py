...
<div style="width:100%; font-size:7pt; font-family:'Segoe UI',Arial,sans-serif; color:#1a3c6e; border-bottom:0.5pt solid #1a3c6e; padding:2mm 0; margin:0 8mm;">
  <span style="float:left; font-weight:600;">Healthcare Process Flows</span>
  <span style="float:right;">HL7 FHIR R5 / HIMSS Healthcare Capability Model</span>
</div>
'''
...
<div style="width:100%; font-size:6.5pt; font-family:'Segoe UI',Arial,sans-serif; color:#888; border-top:0.5pt solid #ccc; padding:1.5mm 0; margin:0 8mm;">
  <span style="float:left;">Generated 2026-07-08</span>
...
<head>
<meta charset="UTF-8">
<title>Healthcare Process Flows - HL7 FHIR / HIMSS</title>
...
with sync_playwright() as p:
    ...
    out_pdf = str(ROOT / "Document" / "healthcare-process-flows.pdf")
    page.pdf(
        path=out_pdf,
        format="A4",
        landscape=True,
