...
<div style="width:100%; font-size:7pt; font-family:'Segoe UI',Arial,sans-serif; color:#1a3c6e; border-bottom:0.5pt solid #1a3c6e; padding:2mm 0; margin:0 8mm;">
  <span style="float:left; font-weight:600;">Banking Process Flows</span>
  <span style="float:right;">BIAN Capability Model Reference</span>
</div>
'''
...
<head>
<meta charset="UTF-8">
<title>Banking Process Flows - BIAN</title>
