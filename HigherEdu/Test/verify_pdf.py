import re
with open(r'D:\RakeshPractice\AIProjects\FunctionalFlows\temp_render.html', encoding='utf-8') as f:
    content = f.read()
...
# Check PDF has SVGs embedded (search for 'svg' in binary)
with open(r'D:\RakeshPractice\AIProjects\FunctionalFlows\higher-education-process-flows.pdf', 'rb') as f:
    pdf_content = f.read()
